...
- 실습 파일
  ...
  | Link                                                                                  | Desc          |
  | ------------------------------------------------------------------------------------- | ------------- |
  | [NL2SQL_1.ipynb](./2/NL2SQL.ipynb) | NL2SQL 실습 |
  | [nl2sql_1.pdf](./2/nl2sql_1.pdf) | NL2SQL 실습 자료 (PDF) |
...
- 실습파일
  ...
  | Link                                                                                  | Desc          |
  | ------------------------------------------------------------------------------------- | ------------- |
  | [RAG.ipynb](./4/RAG.ipynb) | GSDS FAQ RAG 챗봇 실습 |
