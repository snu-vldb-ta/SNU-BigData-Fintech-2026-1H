...
**LiveSQL**: 별도 설치 없이 교수님 교안을 바로 실습할 수 있습니다. GitHub에 LiveSQL 버전 실습 자료가 올라가 있습니다.

다만 권한 설정이나 동시성 제어(concurrency control) 등 환경 제약 때문에 실행이 어려운 쿼리들은 실습 파일에서 제외되어 있습니다.

**Oracle**: 교수님 교안을 거의 그대로 실행할 수 있습니다. LiveSQL에서 하던 것처럼 SCOTT 스키마가 준비되어 있다고 가정하고 실습하시면 됩니다. 교수님 교안과 제공된 .sql 파일로 실습 가능합니다. (Oracle은 상용 DB라 기업에서 많이 사용됩니다.)
